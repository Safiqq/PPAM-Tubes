  ...
  return (
    ...
    >
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        <View>
          <LexendText>
            Cicilan KPRmu adalah Rp146,614,787 dan ini setara dengan 18.3% dari penghasilan
            bulananmu.
          </LexendText>
          <LexendText>
            Rasio ini sudah berbahaya, karena berpotensi mengganggu cash flow mu di masa depan.
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        />
        <View style={{ borderBottomWidth: 2, borderBottomColor: '#BDBDBD' }}>
          <LexendText style={{ fontSize: 10 }}>Total bunga periode fix</LexendText>
          <LexendText
            bold={true}
            style={{ fontSize: 12 }}
          >
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        />
        <View style={{ borderBottomWidth: 2, borderBottomColor: '#BDBDBD' }}>
          <LexendText style={{ fontSize: 10 }}>Total bunga periode floating</LexendText>
          <LexendText
            bold={true}
            style={{ fontSize: 12 }}
          >
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        />
        <View style={{ borderBottomWidth: 2, borderBottomColor: '#BDBDBD' }}>
          <LexendText style={{ fontSize: 10 }}>% Total bunga KPR dari pokok pinjaman</LexendText>
          <LexendText
            bold={true}
            style={{ fontSize: 12 }}
          >
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        />
        <View>
          <LexendText style={{ fontSize: 10 }}>Sisa pokok pinjaman setelah periode fix</LexendText>
          <LexendText
            bold={true}
            style={{ fontSize: 12 }}
          >
