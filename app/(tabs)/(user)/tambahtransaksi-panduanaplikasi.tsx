  ...
  return (
    ...
    >
      <ImageBackground>
        ...
        <LexendText>
          * Gunakan fitur-fitur yang disediakan oleh aplikasi, seperti pelacakan
          pengeluaran, atau pemantauan portofolio investasi. Manfaatkan
          alat-alat ini untuk mengelola keuangan Anda dengan lebih efisien.
        </LexendText>
        <LexendText>
          * Pantau kinerja keuangan Anda melalui aplikasi dan lakukan evaluasi
          secara berkala. Tinjau kemajuan Anda terhadap tujuan keuangan Anda dan
          buatlah penyesuaian jika diperlukan.
        </LexendText>
      </ImageBackground>
    </ScrollView>
  );
