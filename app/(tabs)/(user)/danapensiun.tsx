    ...
    <SafeAreaView className='flex-1 bg-white'>
      <ScrollView>
        ...
        >
          ...
          />
          <LexendText bold={true} className='text-[20px]'>Dana Pensiun</LexendText>
        </ImageBackground>
        <View className='px-7'>
          <Spacer size={24} />
          ...
          <Spacer size={20} />
          <LexendText bold={true}>Dana pensiun yang tersedia sampai saat ini</LexendText>
          <Spacer size={8} />
          <LexendTextInput
            className='border border-[#C5C5C5] rounded-[8px] h-9 px-3'
            placeholder='0'
          ...
          <Pressable className='bg-black h-11 rounded-[12px]'>
            <LexendText bold={true} className='text-[16px] text-white py-3 text-center'>Lihat Hasil Strategi</LexendText>
          </Pressable>
          <Spacer size={32} />
        </View>
      </ScrollView>
