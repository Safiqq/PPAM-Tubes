...
interface InputKalkulatorMenikah {
...
interface OutputKalkulatorMenikah {
...
function kalkulatorDanaMenikah(input: InputKalkulatorMenikah): OutputKalkulatorMenikah {
    const { totalBiayaPernikahan, waktuMenikah, asumsiInflasi, uangSaatIni, targetInvestasiPerBulan, returnInvestasi } = input;
    ...
    const totalBiayaPernikahanDenganInflasi = totalBiayaPernikahan * Math.pow((1 + rInflasi), waktuMenikah);
    ...
    const persentasePokokInvestasi = (totalPokokInvestasi / result1Investasi) * 100;
    const persentaseBungaInvestasi = (totalBungaInvestasi / result1Investasi) * 100;
    ...
    if (!strategiCocok) {
        ...
        const totalPokokRekomendasiNominal = uangSaatIni + (rekomendasiInvestasiPerBulan * n);
        const totalBungaRekomendasiNominal = totalBiayaPernikahanDenganInflasi - totalPokokRekomendasiNominal;
        rekomendasiBreakdownNominal = {
            totalPokokInvestasi: totalPokokRekomendasiNominal,
            persentasePokokInvestasi: (totalPokokRekomendasiNominal / totalBiayaPernikahanDenganInflasi) * 100,
            totalBungaInvestasi: totalBungaRekomendasiNominal,
            persentaseBungaInvestasi: (totalBungaRekomendasiNominal / totalBiayaPernikahanDenganInflasi) * 100
        };
        ...
        const totalPokokRekomendasiDurasi = uangSaatIni + (targetInvestasiPerBulan * rekomendasiDurasiInvestasi);
        const totalBungaRekomendasiDurasi = totalBiayaPernikahanDenganInflasi - totalPokokRekomendasiDurasi;
        rekomendasiBreakdownDurasi = {
            totalPokokInvestasi: totalPokokRekomendasiDurasi,
            persentasePokokInvestasi: (totalPokokRekomendasiDurasi / totalBiayaPernikahanDenganInflasi) * 100,
            totalBungaInvestasi: totalBungaRekomendasiDurasi,
            persentaseBungaInvestasi: (totalBungaRekomendasiDurasi / totalBiayaPernikahanDenganInflasi) * 100
        };
    }
...
console.log("Apakah strateginya cocok? ", result1.strategiCocok ? "Ya" : "Tidak");
console.log("Total biaya pernikahan setelah kena inflasi: ", result1.totalBiayaPernikahanDenganInflasi);
console.log("result1 investasi: ", result1.result1Investasi);
console.log("Breakdown total pokok investasi: ", result1.breakdownInvestasi.totalPokokInvestasi);
console.log("Persentase pokok investasi: ", result1.breakdownInvestasi.persentasePokokInvestasi.toFixed(2), "%");
console.log("Total bunga investasi: ", result1.breakdownInvestasi.totalBungaInvestasi);
console.log("Persentase bunga investasi: ", result1.breakdownInvestasi.persentaseBungaInvestasi.toFixed(2), "%");

if (!result1.strategiCocok) {
    console.log("Rekomendasi nominal investasi per bulan: ", result1.rekomendasiInvestasiPerBulan);
    console.log("Rekomendasi breakdown pokok investasi (nominal): ", result1.rekomendasiBreakdownNominal?.totalPokokInvestasi);
    console.log("Rekomendasi persentase pokok investasi (nominal): ", result1.rekomendasiBreakdownNominal?.persentasePokokInvestasi.toFixed(2), "%");
    console.log("Rekomendasi total bunga investasi (nominal): ", result1.rekomendasiBreakdownNominal?.totalBungaInvestasi);
    console.log("Rekomendasi persentase bunga investasi (nominal): ", result1.rekomendasiBreakdownNominal?.persentaseBungaInvestasi.toFixed(2), "%");
    console.log("Rekomendasi durasi lama investasi (bulan): ", result1.rekomendasiDurasiInvestasi);
    console.log("Rekomendasi breakdown pokok investasi (durasi): ", result1.rekomendasiBreakdownDurasi?.totalPokokInvestasi);
    console.log("Rekomendasi persentase pokok investasi (durasi): ", result1.rekomendasiBreakdownDurasi?.persentasePokokInvestasi.toFixed(2), "%");
    console.log("Rekomendasi total bunga investasi (durasi): ", result1.rekomendasiBreakdownDurasi?.totalBungaInvestasi);
    console.log("Rekomendasi persentase bunga investasi (durasi): ", result1.rekomendasiBreakdownDurasi?.persentaseBungaInvestasi.toFixed(2), "%");
}
