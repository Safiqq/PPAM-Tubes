...
const TimelineInvestasi = () => {
  return (
    <View className="flex flex-row justify-between rounded-[12px] bg-[#F5F5F5] px-3 py-2">
      ...
      <View className="flex-1 items-center">
        <LexendText className="text-[8px] text-[#868686] ">Tahun 3</LexendText>
        <Spacer size={4} />
        <View className="h-2 w-2 rounded-full bg-black" />
        <Spacer size={4} />
        <LexendText className="text-center text-[8px]">
          Pindahkan uangnya ke produk yang lebih rendah risiko, seperti Reksa
          Dana Pasar Uang & Reksa Dana Pendapatan Tetap tertentu
        </LexendText>
      </View>
      <View className="flex-1 items-center">
